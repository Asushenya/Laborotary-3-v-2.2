...
WorkStation::WorkStation(string Name1,							//Product
			...
			Product(Name1), PC(Name2,CPU), Monitor(Name3,Diagonal,PPI),HeadPhone(Name4,down,up),Mouse(Name5,Dpi,Counter)
{
	itemCounter  = counter;
}

WorkStation::WorkStation(Product obj1, PC obj2, Monitor obj3, HeadPhone obj4, Mouse obj5 ,int counter): //конструктор
